This is a Part of RED HAWK PROJECT
...
The first three files are mendetory for the RED/SCORE HAWK scanner. These files have the list of files and directories which the scanner uses for crawling.
